      ...
      <div className="grid gap-10 lg:grid-cols-[1.3fr_0.7fr]">
        <div>
          ...
          <div className="mt-8">
            ...
            <p className="mt-6 leading-7 text-muted-foreground">
              Our professional home cleaning service helps keep your home fresh,
              clean and comfortable. Our verified professionals use quality
              products and follow a detailed cleaning checklist.
            </p>
        ...
        <Card className="h-fit lg:sticky lg:top-24">
          <CardContent className="p-6">
            ...
            <p className="mt-1 text-4xl font-bold">$35</p>
